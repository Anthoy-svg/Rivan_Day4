...
| HR         | 192.168.128.0       | 192.168.130.5 /20 | 
...
conf t
 ...
 line vty 0 14
  ...
  exec-timeout 0 0
 int g1
  ip add 208.8.8. 255.255.255.0
  no shut
 int g2
  ip add 192.168.102. 255.255.255.0
  no shut
 int g3
  ip add ...3 255.255.255.224
  no shut
  exit
 int g4
  ip add 10.11.1. 255.255.255.0
  no shut
  exit
 !
...
sudo su
hostname BLDG-PH
ifconfig eth0 ...1 netmask 255.255.255.224 up
...
sudo su
hostname BLDG-JP-1
ifconfig eth0 21.21.21.2 netmask 255.255.255.240 up
...
ip route add 0.0.0.0/0 via ...3 dev ens224
~~~
...
!@UTM-PH
conf t
 ip route 10.0.0.0 255.0.0.0 10.11.1.4
 ip route 200.0.0.0 255.255.255.0 10.11.1.4
 end
~~~
...
### Task 1: Prevent traffic only from VLAN 100 (CUCM) to reach UTM-PH (10.11.1.)
~~~
!@UTM-PH
config t
...
### Task 2: Prevent traffic coming from the PC (10.11.1.10) and the EDGE Router from reaching UTM-PH (10.11.1.)
~~~
!@UTM-PH
config t
...
### Task 3: Allow the PC (10.11.1.10) to access HTTP, SSH, and ICMP of UTM-PH (10.11.1.)
...
config t
 ...
 telephony-service
  ...
  max-ephones 5
  max-dn 20
  ip source-address 10.11.1. port 2000
  exit
 voice service voip
 ...
 voice register global
  mode cme
  source-address 10.11.1. port 5060
  max-dn 12
  max-pool 12
...
### Task 4: Create an extended ACL for `www.bet.com` that will open the following ports
...
config t
 ...
 ip access-list extended FWP4
  permit  tcp  any  host  www.bet.com  eq  22  log
  permit  ___  any  host  www.bet.com  eq  __  log
...
- Allow Pings destined for your PC (10.11.1.10)  
...
config t
 ip access-list extended FWP5
  permit  icmp  any  host 10.11.1.10             log 
...
conf t
 ...
 ip access-list extended NAT
  deny ip ...96 0.0.0.31  21.21.21.208 0.0.0.15
  deny ip ...96 0.0.0.31  22.22.22.192 0.0.0.63
  exit
 !
 ip nat inside source list NAT int g1 overload
 !
 ip nat inside source static tcp  ...1  80  208.8.8.100  8080
 !
 no ip route 10.0.0.0 255.0.0.0 10.11.1.4
 no ip route 200.0.0.0 255.255.255.0 10.11.1.4
 end
~~~
...
| SERVER      | INSIDE PORT | OUTSIDE IP     | OUTSIDE PORT |
| ---         | ---         | ---            | ---          |
| CoreTAAS    | 23          | 200.0.0.11 | 2023         |
| CoreBABA    | 23          | 200.0.0.11 | 4023         |
| CUCM        | 23          | 200.0.0.11 | 8020         |
...
!@EDGE-11
conf t
 ip nat inside source static tcp  10.11.1.4  23  200.0.0.11  4023
 !
 ip nat inside source static tcp  10.11.1.4  __  __.__.__.__     __
 ip nat inside source static tcp  10.11.1.4  __  __.__.__.__     __
 end
~~~
...
!@EDGE-11
conf t
 ip nat inside source static tcp  10.11.1.  6969  200.0.0.11  3306
 end
~~~
...
conf t
 ...
 no ip nat inside source static tcp ...100 22 208.8.8.100 2202 extendable
 no ip nat inside source static tcp ...1 22 208.8.8.100 2222 extendable
 no ip nat inside source static tcp ...1 80 208.8.8.100 8080 extendable
 no ip nat inside source static tcp ...1 443 208.8.8.100 8443 extendable
 end
~~~
...
!@BLDG-JP-1
sudo su
ifconfig eth0 208.8.8.2 netmask 255.255.255.0 up
route add default gw 208.8.8.
ping 208.8.8.
~~~
...
conf t
 ...
 ip access-list extended NAT-POLICY
  deny ip 10.11.0.0 0.0.255.255 10..0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.12.0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.21.0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.22.0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.31.0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.32.0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.41.0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.42.0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.51.0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.52.0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.61.0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.62.0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.71.0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.72.0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.81.0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.82.0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.91.0.0 0.0.255.255
  deny ip 10.11.0.0 0.0.255.255 10.92.0.0 0.0.255.255
  no deny ip 10.11.0.0 0.0.255.255 10.11.0.0 0.0.255.255
  permit ip any any
  end
~~~
...
conf t
 int tun1
  ...
  no ip nhrp map 172.16.1.11 200.0.0.11
  exit
 !
 !
 ...
 !
 no ip route 10.11.0.0 255.255.0.0 172.16.1.11 252
 end
~~~
...
conf t
 ...
 ip access-list extended NAT
  deny ip ...0 0.0.0.31  21.21.21.208 0.0.0.15
  deny ip ...0 0.0.0.31  22.22.22.192 0.0.0.63
  permit ip any any
 !
...
conf t
 ...
 !
 ip access-list extended NAT
  deny ip 21.21.21.208 0.0.0.15  ...96 0.0.0.31
  deny ip 22.22.22.192 0.0.0.63  ...96 0.0.0.31
  permit ip any any
 !
 ip nat inside source list NAT int g1
 ip route 0.0.0.0 0.0.0.0 208.8.8.2
